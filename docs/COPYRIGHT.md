...
**Tên Dự Án**: Agent skills setup for AntiGravity (Enhanced Edition)  
...
> **Lưu ý**: Các tác giả gốc (`vudovn`, `sickn33`) được ghi nhận vì những đóng góp nền tảng cho cộng đồng mã nguồn mở. Tuy nhiên, họ **không trực tiếp tham gia** phát triển, sửa lỗi hay quản lý repository (`Dokhacgiakhoa/Agent-skills-setup-for-AntiGravity`) này.
